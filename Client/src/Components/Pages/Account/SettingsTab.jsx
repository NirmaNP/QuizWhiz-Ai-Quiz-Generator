  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
          <div>
            <h4 className="font-medium text-gray-900">Leaderboard Participation</h4>
            <p className="text-sm text-gray-500">Show your scores on public leaderboards</p>
          </div>
          <label className="flex items-center cursor-pointer">
    ...
    <div>
      ...
      <div className="space-y-4">
        <button className="w-full text-left p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
          ...
          <p className="text-sm text-gray-500">Download all your quiz data and statistics</p>
        </button>
