...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br relative overflow-hidden">
      ...
      {/* Hero Section */}
      <div className="relative z-10 w-full px-4 py-8 sm:pl-20 md:py-24 text-center  backdrop-blur">
        <div className="max-w-7xl mx-auto">
          <div className="inline-block px-4 py-2 mb-6 bg-white/30 backdrop-blur-md rounded-full border border-white/50 shadow-sm">
          ...
          <div className="flex flex-col items-center justify-center mt-8">
            <div className="flex w-full max-w-2xl group transition-all duration-300 hover:scale-[1.02] focus-within:scale-[1.02] rounded-xl shadow-lg bg-white/50 backdrop-blur-md border border-white/70 overflow-hidden">
              <input
                type="text"
                ...
                className="flex-grow px-6 py-4 bg-transparent text-gray-800 placeholder-gray-500 focus:outline-none"
              />
              <button
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                {[
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-white/70 text-gray-800 font-medium rounded-lg border border-white shadow-sm hover:bg-white hover:shadow-md transition-all duration-200 text-sm backdrop-blur-sm hover:scale-105"
                  >
                    {topic}
                  </button>
                ))}
      ...
      {/* Features Section */}
      <div className="relative z-10 bg-white/30 backdrop-blur-lg py-10 sm:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-white/80">
      ...
      <div className="relative z-10 py-10 sm:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-xl shadow-lg border border-white/80">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                  <FaRegLightbulb className="text-xl text-blue-600" />
                </div>
                <div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-xl shadow-lg border border-white/80">
              <div className="flex items-start gap-4">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-xl shadow-lg border border-white/80">
              <div className="flex items-start gap-4">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-8 rounded-xl shadow-lg border border-white/80">
              <div className="flex items-start gap-4">
      ...
      <div className="relative z-10 bg-white/30 backdrop-blur-lg py-10 sm:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-white/90">
      ...
      <div className="relative z-10 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-12 shadow-2xl">
            ...
            <button
              onClick={handleGenerateClick}
              className="px-8 py-4 bg-white text-blue-600 font-bold rounded-lg shadow-lg hover:bg-gray-100 hover:scale-105 transition-transform duration-300 flex items-center gap-2 mx-auto"
            >
